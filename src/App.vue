  ...
  <div id="app">
    ...
    <main>
      ...
      <div id="about">
        ...
        <div class="about-wrap">
          ...
          <div class="about-right">
            <h3>estra inc.</h3>
            <p>私たちは、お客様の満足度を徹底的に追求することで、お客様・市場・時代のニーズを的確に捉え、事業の拡大と周辺ビジネスによる差別化、業界における圧倒的な地位の確立を図るべく積極的な事業活動を行っています。</p>
            <ol>
              <li>コーチング事業</li>
              <li>プログラミング事業</li>
              <li>SaaS事業</li>
      ...
      <div>
        ...
        <textarea name="user_message" id="msg" v-model="msg"></textarea>
      </div>
      ...
      business: [
        {
          ...
          title: "ビジネスA",
          description:"ビジネスの説明が入ります。ビジネスの説明が入ります。ビジネスの説明が入ります。ビジネスの説明が入ります。"
        },
        {
          img: require("./assets/img/business-icon.png"),
          title: "ビジネスB",
